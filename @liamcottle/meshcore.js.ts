declare module "@liamcottle/meshcore.js" {
  ...
  class Connection extends EventEmitter {
    ...
    sendCommandExportContact(
      pubKey?: Uint8Array<ArrayBuffer> | null,
    ): Promise<void>;

    sendCommandImportContact(
      advertPacketBytes: Uint8Array<ArrayBuffer>,
    ): Promise<void>;
